...
datacatalog_node1754770179465 = glueContext.create_dynamic_frame.from_catalog(database="mydatabase", table_name="product", transformation_ctx="datacatalog_node1754770179465")

logger.info('print schema of datacatalog_node1754770179465')
datacatalog_node1754770179465.printSchema()

count = datacatalog_node1754770179465.count()
logger.info('count for frame is {}'.format(count))



# Script generated for node Change Schema
ChangeSchema_node1754770454150 = ApplyMapping.apply(frame=datacatalog_node1754770179465, mappings=[("marketplace", "string", "new_marketplace", "string"), ("customer_id", "long", "new_customer_id", "long"), ("product_id", "string", "new_product_id", "string"), ("seller_id", "string", "new_seller_id", "string"), ("sell_date", "string", "new_sell_date", "string"), ("quantity", "long", "new_quantity", "long"), ("year", "string", "new_year", "string")], transformation_ctx="ChangeSchema_node1754770454150")


ResolveChoice_node = ChangeSchema_node1754770454150.resolveChoice(specs = [('new_seller_id','cast:long')],
...
EvaluateDataQuality().process_rows(frame=dynamic_frame, ruleset=DEFAULT_DATA_QUALITY_RULESET, publishing_options={"dataQualityEvaluationContext": "EvaluateDataQuality_node1754770153397", "enableDataQualityResultsPublishing": True}, additional_options={"dataQualityResultsPublishing.strategy": "BEST_EFFORT", "observations.scope": "ALL"})

S3bucket_node1754770183324 = glueContext.write_dynamic_frame.from_options(frame=dynamic_frame, connection_type="s3", format="glueparquet", connection_options={"path": "s3://batch-data-glue/output/", "partitionKeys": []}, format_options={"compression": "snappy"}, transformation_ctx="S3bucket_node1754770183324")
